...
class W8A8Linear(nn.Module):
    def __init__(
        ...
        if act_quant == "per_token":
            ...
            self.act_quant = partial(quantize_activation_per_token_absmax, n_bits=self.act_bits)
        elif act_quant == "per_tensor":
            self.act_quant_name = "per_tensor"
            self.act_quant = partial(quantize_activation_per_tensor_absmax, n_bits=self.act_bits)
        else:
    ...
    @staticmethod
    def from_float(
        module, weight_quant="per_channel", act_quant="per_token", w_bits=8, a_bits=8, quantize_output=False
    ):
...
################################ <OPT_Quant> ################################ 
def quantize_opt(
    model, weight_quant='per_tensor', act_quant='per_tensor', w_bits=8, a_bits=8, quantize_bmm_input=True
):
    from transformers.models.opt.modeling_opt import (
        OPTAttention,
        OPTDecoderLayer,
